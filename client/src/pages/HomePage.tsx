  ...
  const coreUnits = [
    {
      ...
      desc: "Custom websites, mobile apps, and enterprise systems built with cutting‑edge tech.",
      link: "/services/software",
    },
    {
      icon: <GraduationCap className="w-8 h-8" />,
      title: "IT Training School",
      desc: "Professional IT and programming courses with certification and mentorship.",
    ...
    },
    {
      ...
      desc: "Premium laptops, phones, accessories, and gadgets with delivery.",
      link: "/commerce",
    },
  ];
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden">
      ...
      >
        ...
        System: {status === "online" ? "Live ERP Connected" : "Offline"}
      </motion.div>
      ...
      <section className="relative min-h-screen flex flex-col justify-center items-center text-center px-6 pt-20">
        ...
        >
          <h1 className="text-6xl md:text-8xl font-black tracking-tight bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent leading-tight">
            STAR MEDIA TECH
          </h1>
          <p className="mt-6 max-w-3xl text-gray-300 text-xl md:text-2xl font-light">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {coreUnits.map((unit, i) => (
            ...
            >
              ...
              <p className="text-gray-400 text-sm leading-relaxed">{unit.desc}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-white/[0.02]">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 mt-4">We deliver excellence through innovation, reliability, and expert execution.</p>
          </motion.div>
        ...
        <div className="max-w-3xl mx-auto text-center bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-white/10 rounded-3xl p-10 backdrop-blur-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <input
              ...
              className="px-6 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-cyan-400"
            />
