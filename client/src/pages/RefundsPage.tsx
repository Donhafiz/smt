...
export default function RefundsPage() {
  return (
    <div className="min-h-screen pt-28 px-6 max-w-4xl mx-auto pb-20">
      <h1 className="text-5xl font-black bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent mb-4">Refund Policy</h1>
      <p className="text-gray-400 mb-8">Last updated: 2026</p>
